...
// Created for: ICS3U
// This program calculates factorial with for loop
...
class ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        instructionLabel.text = "Enter a number to calculate factorial"
        ...
        numberEnteredTextField.placeholder = "Enter a number between 1 and 100"
